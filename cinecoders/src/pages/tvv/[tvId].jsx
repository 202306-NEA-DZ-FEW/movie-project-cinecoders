...
export async function getServerSideProps(context) {
  ...
  const url1 = `https://api.themoviedb.org/3/tv/${movieId}?language=en-US`
  

  const url2 = `https://api.themoviedb.org/3/tv/${movieId}/credits?language=en-US`
  const url3 = `https://api.themoviedb.org/3/tv/${movieId}/similar?language=en-US&page=1`
  const url4 = `https://api.themoviedb.org/3/tv/${movieId}/videos?language=en-US`
