...
export default function ActorPage({ actorInfo }) {
  const genderSet = () => {
        ...
        <Container style={{ height: "auto", marginTop: "5rem" }}>
          ...
          >
            ...
            <Grid
              ...
              xs={12}
              md={6}
              style={{ paddingLeft: "3rem", fontSize: "20px", height: "450px" }}
            >
              ...
              <div className="marginTop">
                ...
                <ul className="ulPls">
                  ...
                  <li>
                    <b>Popularity:</b> {actorInfo.popularity}
                  </li>
                </ul>
              </div>
            </Grid>
            ...
            >
              <div className="marginTop">&quot;{actorInfo.biography}&quot;</div>
            </Grid>
          </Grid>
        </Container>
      </div>
